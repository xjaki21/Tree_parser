...
int main(int argc, char const** argv){
    ...
    // Leggere i dati nel trie
        ...
        in.close();
        const trie<string> t1=t;
        cout<<t<<endl;
        cout<<(t1==t)<<endl;
        const trie<string>& comp=t1[{"languages","java",}];
        cout<<(t1[{"compilers"}]==t[{"compilers"}])<<endl;
        cout<<comp<<endl;
       // auto it=t.begin();
    ...
    trie<string> empty;
    std::vector<string> prefix{"languages"};
    auto t2 = empty[prefix];
    cout<<t<<endl;
    cout<<empty<<endl;
